...
Il circuito è costituito da FSM (Controllore) e Datapath (elaboratore). I due file che racchiudono la rappresentazione di tali componenti sono presenti nella cartella \emph{sis}.
I due componenti sono collegati tra di loro in un unico circuito sequenziale chiamato \emph{FSMD.blif}.

\noindent Nella figura \ref{fig:architettura_generale} è rappresentata l'architettura generale del circuito
