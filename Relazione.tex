...
Di seguito vengono riportati tutti i componenti utilizzati per la realizzazione di questo circuito:
...
Le componenti che abbiamo utilizzato per l'elaborazione del nostro circuito sono le seguenti, presentate sottoforma di \textbf{Nome Componente} e \textbf{Numero di Occorrenze}.
